...
If you haven't already, come find us in IRC (#contao on freenode).
We want you working on things you're excited about.

The following is a set of guidelines for contributing to MultiColumnWizard (MCW), which
are hosted in the [CCA organization][1] on GitHub. These
...
* Describe the issue in detail and include all the steps to follow in order to
  reproduce the bug.
* Include the version of Contao, PHP and MultiColumnWizard (MCW) you are using
  (if possible with a detailed list of other installed extensions that might be
  related).
...
* Please send a [GitHub Pull Request to Clipboard][1] with a clear list of what
...
[4]: https://github.com/contao-community-alliance/contao-multicolumnwizard-bundle/pull/new/master
[5]: https://github.com/contao-community-alliance/contao-multicolumnwizard-bundle/pull/new/develop
