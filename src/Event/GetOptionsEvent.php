...
use ContaoCommunityAlliance\MultiColumnWizardBundle\Contao\Widgets\MultiColumnWizard as BundleMultiColumnWizard;
...
class GetOptionsEvent extends Event
{
     ...
     * Name of this event.
     */
    const NAME = 'contao-community-alliance.multi-column-wizard-bundle.get-options';
